...
let promediar = (diasmax, diasmin) => {
    for (let i = 0; i < diasmax.length; i++) {
        const media = (diasmax[i]+diasmin[i])/2
        
        console.log(`El promedio del dia ${i+1} fue ${media}`);
    }
}
